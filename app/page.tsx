      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xl font-heading font-bold text-foreground">StreamLine</span>
          </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-heading font-bold text-foreground mb-6 leading-tight">
            Streamline Your Workflow, <span className="text-primary">Amplify Your Success</span>
          </h1>

          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
            Transform how your team collaborates with our intelligent project management platform. Boost productivity by
            40% and never miss a deadline again.
          </p>
  ...
  const features = [
    {
      ...
      description: "Experience blazing-fast load times and real-time collaboration with our optimized infrastructure.",
    },
    {
      icon: <Shield className="w-8 h-8 text-primary" />,
      title: "Enterprise Security",
      description: "Bank-level encryption and compliance with SOC 2, GDPR, and HIPAA standards keep your data safe.",
    },
    {
      icon: <Users className="w-8 h-8 text-primary" />,
      title: "Team Collaboration",
      description: "Seamlessly work together with real-time editing, comments, and integrated communication tools.",
    },
    {
      icon: <CheckCircle className="w-8 h-8 text-primary" />,
      title: "Smart Automation",
      description: "AI-powered workflows that learn from your patterns and automate repetitive tasks automatically.",
    },
  ]
...
function TestimonialsSection() {
  const testimonials = [
    {
      ...
      content:
        "StreamLine transformed our project management. We've reduced meeting time by 60% and increased delivery speed by 40%.",
      rating: 5,
    },
    {
    ...
    },
    {
      ...
      content:
        "Finally, a tool that actually improves our workflow instead of complicating it. The interface is intuitive and powerful.",
      rating: 5,
    },
  ]
  ...
  return (
    <section id="testimonials" className="py-20 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-heading font-bold text-foreground mb-4">Loved by Teams Worldwide</h2>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
  ...
  const plans = [
    {
      ...
      features: ["Up to 5 team members", "10 projects", "Basic automation", "Email support", "Mobile app access"],
      popular: false,
    },
    {
      name: "Professional",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
            Join over 10,000 teams who have already streamlined their processes and boosted productivity with
            StreamLine.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button size="lg" variant="secondary" className="bg-white hover:bg-white/90 text-primary px-8 py-3 text-lg">
    ...
    <footer className="bg-card border-t border-border py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Streamlining workflows for teams worldwide. Built with ❤️ for productivity.
            </p>
        ...
        <div className="border-t border-border mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm">© 2024 StreamLine. All rights reserved.</p>
